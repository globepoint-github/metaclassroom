...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -144834485L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QComment comment = new QComment("comment");

    public final com.java.metaclassroom.common.QBaseEntity _super = new com.java.metaclassroom.common.QBaseEntity(this);
